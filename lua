spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Welcome To Phu Hub <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join Phu's Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Window =
    ...
    {
        Title = "Truong Hub",
        SubTitle = "Create by setup Truong Community ",
        TabWidth = 160,
...
do
    Tabs.Discord:AddButton(
        {
            Title = "Copy Link Discord Trường roblox",
            Description = "https://discord.gg/yZDRPEVXtz",
            Callback = function()
                setclipboard("https://discord.gg/yZDRPEVXtz")
                Fluent:Notify(
                    {
                        Title = "Truong Hub",
                        Content = "Copied!",
    ...
    Tabs.Discord:AddButton(
        {
            ...
            Description = "Trường roblox",
            Callback = function()
                setclipboard("Trường roblox")
                Fluent:Notify(
                    {
                        Title = "Trường Hub",
                        Content = "Copied!",
...
ImageButton.Image = "rbxassetid://16118246568"
